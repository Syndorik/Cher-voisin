...
<body>
  ...
  <nav class="navbar navbar-default navbar-fixed-top navbar-center" id="header_landing">
    <div class="container-fluid container">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-center" id="menu-items">
          ...
          <li><a href="#">Besoin d'un objet ?</a></li>
  ...
  <div class="container" id="landing_container">
    ...
    </section><!-- END of slideshow row -->

    <section class="row" id="description_row">
      <div class="col-md-12">
    ...
    </section><!-- END of description_row -->

    <section class="row" id="test_row">
      <div class="col-md-12">
        <h2>Test notre plateforme !</h2>
        <h4>Déjà plein de campus avec de nombreux objets prêtés !</h4>
        <div class="row container" id="test_container">
          <form action="index.html" method="post">
            <div class="col-md-3">
              <select class="form-control" id ="batiment" name ="bat">
                  ...
                  <option value = "autre">Mon campus n'est pas présent</option>
              </select>
            </div>
